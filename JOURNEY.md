...
If you're another agent picking up this codebase later: read `MD/System_Principles.md` first, then the per-round design docs in `MD/`. Listen for the framings before proposing architecture — most decisions in this codebase came from naming a frustration out loud rather than designing top-down.
